...
public class KevTest {
    ...
    public KevTest(Args args) throws Exception {
        this.service = Main.PKI_INIT.main(args);
...
*/
    ...
    public void kevTest()  {
        ...
        NetworkAccess shareeNode = network2;
        int shareeCount = 1;
        ...
        //shareeUsers = getUserContextsForNode(shareeNode.clear(), random, shareeCount, shareePasswords);
